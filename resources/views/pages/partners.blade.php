...
@section('content')
    ...
    <!-- Video -->
    <div class="bg-[#efeded] w-full flex justify-center z-20 mb-20" style="margin-top: -15rem;">
    ...
    <section class="w-full bg-[#efeded] px-6">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <p
                ...
                Activa tu propio negocio de automatización comercial con soluciones de inteligencia artificial listas para
                vender y escalar
            </p>
    ...
    <section class="w-full bg-[#d7d5d7] text-white pt-10 pb-0 px-6 lg:px-12">
        <div
            class="max-w-7xl lg:max-w-9/10 mx-auto flex flex-col lg:flex-row justify-between items-end gap-20">
            ...
            <!-- Texto -->
            <div class="w-full lg:w-2/3 max-w-5xl text-black justify-center items-center mb-10 lg:mb-20">
                <h2
