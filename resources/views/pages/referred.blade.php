...
@section('content')
    ...
    <section class="relative pt-60 pb-30 mb-0">
        ...
        <!-- Overlay -->
        <div class="relative z-10 w-full mx-auto px-4 flex flex-col lg:flex-row items-center justify-between pt-10">

            <!-- Left Content -->
            <div class="ml-20 lg:w-2/3 text-center sm:text-center lg:text-left">
                <h1
                    ...
                    Recomienda Amotii, gana ingresos
                </h1>
                <h1
                    class="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold text-orange-500 mb-4 hover:scale-105 transition-transform duration-300 ease-in-out">
                ...
                <a href="{{ route('contact') }}"
                    class="bg-orange-500 text-white text-lg lg:text-2xl px-8 py-3 mt-5 rounded-full shadow-md hover:shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-orange-400 inline-block"
            ...
            <!-- Right Content -->
            <div
                class="relative lg:absolute md:none lg:right-0 lg:top-1/2 lg:translate-y-[-50%] w-full lg:w-1/2 flex justify-center lg:justify-end lg:mt-18 z-10">
                <img src="{{ asset('assets/img/refered/img_h.png') }}" alt="Hero Image" class="w-full max-w-full h-auto">
            </div>
        </div>
    </section>
    <!-- End Header Section -->
    ...
    <section x-data="referidos" class="bg-[#f4f4f4] w-full py-16 sm:px-10">
        <div class="max-w-7xl lg:max-w-10/10 mx-auto  text-center">
            <h2 class="lg:text-5xl sm:text-3xl md:text-4xl font-extrabold text-orange-500 mb-20">
                ¿Cómo funciona el Plan de Referidos de Amotii?
            </h2>
    ...
    <section class="w-full bg-[#efeded] text-white py-20 pb-0 px-6 lg:px-12">
        <div
            class="max-w-7xl lg:max-w-10/10 mx-auto flex flex-col lg:flex-row lg:justify-between items-center gap-12 lg:gap-25">
            <!-- Texto -->
            <div class="w-full lg:w-2/3 max-w-4xl text-black ">
                <h2
                    class="text-xl text-orange-500 sm:text-3xl lg:text-4xl lg:max-w-3xl font-semibold tracking-wide mb-4 sm:mb-6 text-center lg:text-left hover:scale-105 transition-transform duration-300 ease-in-out">
                    Monitorea, gestiona y gana con claridad
                </h2>
        ...
        <div class="max-w-7xl lg:max-w-9/10 mx-auto px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <p
                        class="text-black text-lg lg:max-w-lg lg:text-2xl leading-relaxed hover:scale-105 transition-transform duration-300 ease-in-out">
        ...
        <div class="w-full mx-auto">
            <div class="flex flex-col md:flex-row items-center justify-between gap-y-10 md:gap-20">
                ...
                <div class="w-full md:w-1/2 text-center md:text-left">
                    <h2
                        class="text-2xl md:text-3xl lg:text-4xl font-bold text-orange-500 mb-4 hover:scale-105 transition-transform duration-300 ease-in-out">
                        Sugerencias de productos basadas en IA
                    </h2>
                    <p
                        class="text-black text-base sm:text-lg lg:text-2xl leading-relaxed hover:scale-105 transition-transform duration-300 ease-in-out">
    ...
    <section class="w-full bg-orange-500 text-white py-20 pb-0 px-6 lg:px-12">
        <div class="max-w-7xl lg:max-w-9/10 mx-auto flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="w-full lg:w-2/3 max-w-4xl">
                <h2
                    class="text-xl sm:text-3xl lg:text-4xl font-normal tracking-wide mb-4 sm:mb-6 text-center lg:text-left hover:scale-105 transition-transform duration-300 ease-in-out">
    ...
    <section class="w-full bg-[#ff6600] text-white px-4 sm:px-6 py-14 sm:py-16">
        <div
            ...
            <div class="w-full lg:w-4/7 max-w-3xl text-center sm:text-left">
                <h2
                    class="text-2xl sm:text-3xl md:text-4xl text-white font-semibold mb-4 sm:mb-6 hover:scale-105 transition-transform duration-300 ease-in-out">
                    Personalización total, adaptada a tu estrategia
                </h2>
                <p
                    class="text-base sm:text-lg md:text-xl font-light leading-relaxed mb-6 sm:mb-8 hover:scale-105 transition-transform duration-300 ease-in-out">
