        ...
        return {
            ...
            tools: [{
                ...
                },
                {
                    ...
                    icon: '/assets/img/index/icons/recopilacion-de-datos.webp',
                    isWhite: 'No',
                    route: '{{ route('tiicall.index') }}',
                ...
                },
                {
                    ...
                    icon: '/assets/img/index/icons/email_12574740.webp',
                    isWhite: 'No',
                    route: '{{ route('tiicall.index') }}',
    ...
    function carouselSection() {
        return {
            ...
            slides: [{
                    ...
                    icon: '{{ asset('assets/img/index/icons/icon.webp') }}',
                    link: '#'
                },
                {
                    ...
                    icon: '{{ asset('assets/img/index/icons/icon2.webp') }}',
                    link: '#'
                },
                {
                    ...
                    icon: '{{ asset('assets/img/index/icons/icon3.webp') }}',
                    link: '#'
                },
            ],
            startAutoplay() {
        ...
        return {
            ...
            tabs: [{
                    ...
                    content: {
                        ...
                        image: "{{ asset('assets/img/products/tiicall/phone2.webp') }}"
                    }
                },
                {
